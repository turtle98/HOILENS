...
import utils.vcoco_text_label as vcoco_text_label
...
def compute_object_n_verb_to_interaction(num_object_cls, num_action_cls, class_corr):
    """
...
object_n_verb_to_interaction = None
def vcoco_object_n_verb_to_interaction(*args,**kwargs):
    global object_n_verb_to_interaction
    if object_n_verb_to_interaction is None:
        object_n_verb_to_interaction = compute_object_n_verb_to_interaction(*args,**kwargs)
    return object_n_verb_to_interaction
...
class VCOCO(ImageDataset):
    ...
    def __init__(self, root: str, anno_file: str,
        ...
        self.object_n_verb_to_interaction = vcoco_object_n_verb_to_interaction(num_object_cls=len(self.objects), num_action_cls=len(self.actions), class_corr=self.class_corr)
