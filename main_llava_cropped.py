...
from models.ours_llava_union import build_detector
from utils.args import get_args

from datasets.__init_cache__ import DataFactory, custom_collate
from engine_llava import CustomisedDLE
...
def main(rank, args):
    if args.use_ddp:
        ...
        seed = args.seed
        torch.cuda.set_device(rank)  # or tor
   ...
   # import pdb; pdb.set_trace()
    ...
    trainset = DataFactory(name=args.dataset, partition=args.partitions[0], data_root=args.data_root,
                           clip_model_name=args.clip_model_name, detr_backbone = 'R50',zero_shot=args.zs, zs_type=args.zs_type,
    ...
    testset = DataFactory(name=args.dataset, partition=args.partitions[1], data_root=args.data_root,
                          clip_model_name=args.clip_model_name,  detr_backbone = 'R50',args=args)
