...
class HOILLAVA(nn.Module):
    ...
    def compute_sim_scores(self, region_props: List[dict], image, targets, priors=None):
        ...
        for b_idx, props in enumerate(region_props):
            ...
            #ref_llava_feat_for_roi = ref_llava_features.float().view(1, 24, 24, 4096).permute(0, 3, 1, 2)
            ...
            # Per-layer LLaVA context: layer i of cross-attend attends to hidden_states[start_layer+i]
            llava_context_list = [
