...
class HOIQWEN_SFT(nn.Module):
    ...
    def compute_sim_scores(
        ...
        for b_idx, props in enumerate(region_props):
            ...
            del _roi_input
            ho_queries = ho_feats0.flatten(2).mean(-1).unsqueeze(0).to(img_feat.dtype)
            ...
            output = self.vlm.language_model(
                ...
                output_attentions=self.training_stage == 1,
                return_dict=True,
            )
    ...
    def forward(
        ...
        logits, prior, bh, bo, objects, gen_losses, inter_logits, inter_losses, attn_losses, attn_n_pairs_list = self.compute_sim_scores(
