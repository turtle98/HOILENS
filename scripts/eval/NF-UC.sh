...
CUDA_VISIBLE_DEVICES=0 python main.py \
                       ...
                       --dataset hicodet --num-workers 6 --num_classes 117 --zs --zs_type non_rare_first --output-dir checkpoints/debug \
                       --use_hotoken --use_prompt --N_CTX 36 --CSC --use_exp \
                       --use_insadapter --adapt_dim 32 --use_prior \
                       --resume /home/oreo/PycharmProjects/LAIN/checkpoints/NF.pt --eval --debug --port 11549
