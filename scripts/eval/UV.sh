...
CUDA_VISIBLE_DEVICES=0 python main.py \
                              ...
                              --dataset hicodet --num-workers 6 --num_classes 117 --zs --zs_type unseen_verb --output-dir checkpoints/debug \
                              --use_hotoken --use_prompt --N_CTX 36 --use_exp \
                              --use_insadapter --adapt_dim 32 --use_prior \
                              --resume /home/oreo/PycharmProjects/LAIN/checkpoints/UV.pt --eval --debug --port 11547