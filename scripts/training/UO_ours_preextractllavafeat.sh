...
CUDA_VISIBLE_DEVICES=4 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
         main.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /home/taehoon/LAIN/checkpoints/NRF/best_orighoverb_steplr_1e4 \
         --dataset hicodet --zs --zs_type unseen_object --num_classes 117 --num-workers 4 \
         --epochs 20 \
         --adapt_dim 128 --batch-size 4 \
         --print-interval 100 --linear_shortcut #-resume /home/taehoon/LAIN/checkpoints/UO/128_justcrossattn_noalpha_30_lrdrop20/ckpt_58410_30.pt
