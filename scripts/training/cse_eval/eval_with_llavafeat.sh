...
CUDA_VISIBLE_DEVICES=0 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
         ...
         --print-interval 100 --layer 30 --zse #--cse --resume /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/1108/NRF/30/epoch15_lr1e3_drop10_noscale_klzse05_backtoours_objnorm_batch8_2gpu/ckpt_05195_05.pt
