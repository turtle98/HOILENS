...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
         main_llava_training.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /home/taehoonsong/HOILENS/checkpoints/ECCV/train/0222/UV/ours_new_3branchshareweights_lora_rank16_31_withdetr_withspatialhoforall_noattnmask_verbprojection_weightedmeanofallvocab_noklloss_originallogitloss_epoch30_drop15_withqueryselfattnadded_objclassadded \
         ...
         --print-interval 100 --layer 31 --per_class_ap --eval --resume /home/taehoonsong/HOILENS/checkpoints/ECCV/train/0222/UV/ours_new_all3branch_twolayer_lora_rank16_31_withdetr_withspatialho_withattnmaskho_weightedmeanforallvocab_noklloss_epoch30_drop15_noqueryselfattnadded_objclassadded/ckpt_31108_14.pt
