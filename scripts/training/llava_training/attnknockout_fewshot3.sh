...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
         main_llava_training.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /home/taehoon/HOILENS/checkpoints/ECCV/train/0213/ours_llavaloraonly_top256_lora8_25to32 \
         ...
         --print-interval 100 --layer 32 #--resume /home/taehoon/HOILENS/checkpoints/ECCV/train/0213/ours_llavaloraonly_top256_lora4_25to32/ckpt_22220_10.pt --eval # --eval
