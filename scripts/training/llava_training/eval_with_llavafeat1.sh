...
CUDA_VISIBLE_DEVICES=5 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
         main_llava_training.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/NRF/30/epoch20_lr1e4_drop10_nosigmoid_objnorm_batch8_2gpu_1105 \
         ...
         --print-interval 100 --layer 30 --eval --zse --resume /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/NRF/30/epoch20_lr1e4_drop10_nosigmoid_objnorm_batch8_2gpu_1105/ckpt_05195_05.pt
