...
CUDA_VISIBLE_DEVICES=0,4 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
         main_llava_training.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/NRF/30/epoch15_lr1e3_drop10_nosigmoid0_mlpproj_objnorm_batch8_2gpu_1106 \
         ...
         --print-interval 100 --layer 30 #--eval --resume /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/NRF/30/epoch10_lr1e3_drop5_nosigmoid0_changebacktoours_objnorm_batch8_2gpu_1106/ckpt_11429_11.pt

# CUDA_VISIBLE_DEVICES=5,6 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
#          main_llava_training.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/RF/30/epoch10_lr1e3_drop5_nosigmoid0_changebacktoours_objnorm_batch8_2gpu_1106 \
#          --dataset hicodet --zs --zs_type rare_first --num_classes 117 --num-workers 4 \
#          --epochs 10 --lr-head 1e-3 --lr-drop 5 \
#          --adapt_dim 128 --batch-size 8 \
#          --print-interval 100 --layer 30 #--eval --zse --resume /hub_data1/taehoonsong/LAIN/c
