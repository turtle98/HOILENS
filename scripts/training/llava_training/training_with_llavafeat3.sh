...
# CUDA_VISIBLE_DEVICES=3,4 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
#          main_llava_training.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/1108/NRF/30/epoch15_lr1e3_drop10_noscale_klzse05_backtoours_objnorm_batch8_2gpu \
...
CUDA_VISIBLE_DEVICES=3,4 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
         main_llava_training.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/1108/UO/30/epoch15_lr1e3_drop10_noscale_klzse05_backtoours_objnorm_batch8_2gpu \
         --dataset hicodet --zs --zs_type unseen_object --num_classes 117 --num-workers 4 \
         --epochs 15 --lr-head 1e-4 --lr-drop 20 \
         --adapt_dim 128 --batch-size 8 \
         --print-interval 100 --layer 30 --zse --resume /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/1108/UO/30/epoch15_lr1e3_drop10_noscale_klzse05_backtoours_objnorm_batch8_2gpu/ckpt_21417_11.pt #--eval --zse --resume /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/UV/30_epoch20_lr1e4_drop10_nosigmoid_new_1104/ckpt_11110_05.pt


CUDA_VISIBLE_DEVICES=3,4 torchrun --rdzv_id $id --rdzv_backend=c10d --nproc_per_node=$gpu_num --rdzv_endpoint=127.0.0.1:$port \
         main_llava_training.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/1108/UV/30/epoch15_lr1e3_drop10_noscale_klzse05_backtoours_objnorm_batch8_2gpu \
         --dataset hicodet --zs --zs_type unseen_verb --num_classes 117 --num-workers 4 \
         --epochs 15 --lr-head 1e-3 --lr-drop 10 \
         --adapt_dim 128 --batch-size 8 \
         --print-interval 100 --layer 30 --zse 
         #--eval --zse --resume /hub_data1/taehoonsong/LAIN/checkpoints/CVPR/orig_llava/no_text_tokens/UV/30_epoch20_lr1e4_drop10_nosigmoid_new_1104/ckpt_11110_05.pt
