...
CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=6,7 python main_llava.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /home/taehoon/LAIN/checkpoints/LLavazeroshot_origfeat_layer20_roialign_ingonly \
         ...
         --print-interval 100 --linear_shortcut --layer 20 --eval #--save_dir /home/taehoon/HOICLIP/data/features_llava  # --resume /home/taehoon/LAIN/check

CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=6,7 python main_llava.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /home/taehoon/LAIN/checkpoints/LLavazeroshot_origfeat_layer10_roialign_ingonly \
         --dataset hicodet --num_classes 117 --num-workers 4 \
         --epochs 1 --use_hotoken --use_prompt --use_exp --CSC --N_CTX 36 \
         --use_insadapter --adapt_dim 128 --use_prior --adapter_alpha 1. --batch-size 1 \
         --print-interval 100 --linear_shortcut --layer 10 --eval #--save_dir /home/


CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=6,7 python main_llava.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /home/taehoon/LAIN/checkpoints/LLavazeroshot_origfeat_layer40_roialign_ingonly \
         --dataset hicodet --num_classes 117 --num-workers 4 \
         --epochs 1 --use_hotoken --use_prompt --use_exp --CSC --N_CTX 36 \
         --use_insadapter --adapt_dim 128 --use_prior --adapter_alpha 1. --batch-size 1 \
         --print-interval 100 --linear_shortcut --layer 40 --eval #--save_dir /home/
