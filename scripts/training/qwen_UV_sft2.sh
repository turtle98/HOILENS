...
CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun \
    ...
    train_hoi_sft.py \
        ...
        --output-dir checkpoints/NRF/hoi_sft_withhofusion_withhospatialfusion_withattn_with6verbforms_captionloss_leaveoneout_448_256_withinterloss10onhoqueries_fixed_twostage_epoch10 \
        --dataset hicodet \
        --data-root ./hicodet \
        ...
        --per_class_ap \
        --use-img-cross-attn \
        --resume /home/taehoonsong/HOILENS/checkpoints/NRF/hoi_sft_withhofusion_withhospatialfusion_withattn_with6verbforms_captionloss_leaveoneout_448_256_withinterloss10onhoqueries_fixed_twostage/ckpt_10390_10.pt
        #--eval \
