...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun \
    ...
    train_hoi_sft.py \
        ...
        --output-dir checkpoints/NRF/non_gt/topk64_lora_newmodules_interlossinprior_nogenloss_newformulation \
        --dataset hicodet \
        --data-root ./hicodet \
        ...
        --per_class_ap \
        --no-gen-loss \
        #--resume /home/taehoonsong/HOILENS/checkpoints/NRF/non_gt/top64_notrainlmhead_448_lora_attnonly_interlossinprior_nogenloss_sumform/ckpt_20780_20.pt \
        #--eval
