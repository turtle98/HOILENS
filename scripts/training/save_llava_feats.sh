...
CUDA_VISIBLE_DEVICES=2,3,4,5 python main_llava.py --pretrained checkpoints/pretrained_detr/detr-r50-hicodet.pth --clip_dir_vit checkpoints/pretrained_clip/ViT-L-14-336px.pt --output-dir /home/taehoon/LAIN/checkpoints/LLavazeroshot_origfeat \
