...
from models.ours_qwen_hoi_sft_listwise import build_hoi_sft_detector
...
def main(rank, args):
    ...
    lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optim, T_max=args.epochs, eta_min=1e-7)
