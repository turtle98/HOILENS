...
def get_args():
    ...
    parser.add_argument('--layer', default=30, type=int)
    parser.add_argument('--save_dir', default="/home/taehoon/HOICLIP/data/features_llava", type=str)
    ...
    parser.add_argument('--llava_feature_dir', default='/home/taehoon/HOICLIP/data/features_llava')
    ...
    parser.add_argument('--linear_shortcut', action='store_true', help='')
    parser.add_argument('--fps', action='store_true', help='')
    parser.add_argument('--cls_token', action='store_true', help='')
